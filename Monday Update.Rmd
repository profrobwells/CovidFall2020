...
Sat_New_Cases_Today <- c(764)
Sat_New_Deaths_Today <- c(3)
Sat_active_cases <- c(4912)
Sat_deaths <- c(5916)
Sat_positive <- c(351342)
mydate <- as.Date(c('2021-07-03'))
...
Sun_New_Cases_Today <- c(244)
Sun_New_Deaths_Today <- c(3)
Sun_active_cases <- c(4886)
Sun_deaths <- c(5919)
Sun_positive <- c(351587)
mydate <- as.Date(c('2021-07-04'))
