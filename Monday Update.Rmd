...
Sat_New_Cases_Today <- c(250)
Sat_New_Deaths_Today <- c(3)
Sat_active_cases <- c(2950)
Sat_deaths <- c(5900)
Sat_positive <- c(349000)
...
Sun_New_Cases_Today <- c(275)
Sun_New_Deaths_Today <- c(6)
Sun_active_cases <- c(2970)
Sun_deaths <- c(5950)
Sun_positive <- c(350000)
...
# 
weekend <- rbind(daily, sat_daily, sun_daily)
#
weekend <- weekend %>%
   arrange(desc(Date))
#
