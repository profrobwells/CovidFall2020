...
#Using master_file, answer record number of cases for a Wednesday
...
#Create Wednesday-only table, statewide data
```{r}
...
ggplot(wed, aes(x=date, y=New_Cases_Today, color = New_Cases_Today, fill=New_Cases_Today)) +
  geom_col() +
