---
title: "Downloading Data 9-9-2020"
author: "Rob Wells"
date: "9/9/2020"
...
```{r}
state_hospitals_part1 <- rio::import('https://github.com/profrobwells/CovidFall2020/raw/master/state_hospitals_part1.csv')
View(state_hospitals_part1)
```
# Number columns
```{r}
ncol(state_hospitals_part1)
```
# Number rows
```{r}
nrow(state_hospitals_part1)
```
...
#We're not using these now - long story
...
- **Download Daily State Data - Manual Input" from Google Sheet**
...
```{r}
state <- rio::import("/Users/rswells/Downloads/Daily State Data - Manual Input.xlsx")
...
```{r}
#Check to see the names andvariables changed
glimpse(state)
```
