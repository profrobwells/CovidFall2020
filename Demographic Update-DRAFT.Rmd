...
today_race <- today_demo %>% 
   select(Date, Black, White, Na, Asian, Pi, Hispanic, Multi_Race, Other_Race, Unk_Race, Deaths_Black, Deaths_White, Deaths_Na, Deaths_Asian, Deaths_Pi, Deaths_Hispanic, Deaths_Multi_Race, Deaths_Other_Race, Deaths_Unk_Race)
names(today_race)
```
