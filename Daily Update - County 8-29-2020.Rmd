...
-**Call Google for access
```{r}
#gs_auth(path ="Google.access.arkcovid.json")
...
google_app <- httr::oauth_app(
  "ArkCovid",
  key = "675313068698-7mgde8142jsmecqppt3ume6san11l1l6.apps.googleusercontent.com",
  secret = "b1xvgkqcdWcJGVUpQ6dQgYuY"
)
