...
author: "Rob Wells, Thanks to Mary Hennigan, Translation by Rachell Sanchez-Smith"
date: "8/7/2021"
output: pdf_document
---
...
z <- fromJSON('https://services5.arcgis.com/vlhGQkz6fSnofVMD/ArcGIS/rest/services/ADH_COVID19_STATS_BY_STATE/FeatureServer/0/query?where=0%3D0&objectIds=&time=&resultType=none&outFields=*&returnIdsOnly=false&returnUniqueIdsOnly=false&returnCountOnly=false&returnDistinctValues=false&cacheHint=false&orderByFields=&groupByFieldsForStatistics=&outStatistics=&having=&resultOffset=&resultRecordCount=&sqlFormat=none&f=pjson&token=')
...
today_demo [2:106] <- lapply(today_demo [2:106], as.numeric)
today_demo$date <- as.Date(today_demo$date)
glimpse(today_demo)
```

```{r}
#rename  rename(NEW NAME = OLD NAME,
today_demo <- today_demo %>% 
rename(Black = black, White = white, 
Na = na, Asian = asian, Pi = pi, 
Other_Race = other_race, Unk_Race = unk_race,
Multi_Race = multi_race, Nonhispanic = nonhispanic, 
Hispanic = hispanic, Deaths_Black = d_black, 
Deaths_White = d_white, Deaths_Na = d_na, 
Deaths_Asian = d_asian, Deaths_Pi = d_pi, 
Deaths_Other_Race = d_other_race, 
Deaths_Unk_Race = d_unk_race, 
Deaths_Multi_Race = d_multi_race, 
Cases_0_10 = age_1, 
Cases_11_17 = age_2, 
Cases_18_24 = age_3,
Cases_25_34 = age_4,
Cases_35_44 = age_5,
#New Field in July 2021
#This replaced d_age_2 on Aug 6
Deaths_0_17 = d_age_1,
Deaths_18_24 = d_age_3,
Deaths_25_34 = d_age_4,
Deaths_35_44 = d_age_5,
Male = male,Female = female,
Unk_Gender = unk_gender,
Diabetes = diabetes, Cardiac_Disease = cardiac_disease,
Hypertension = hypertension,
Cpd = cpd, Ckd=ckd,
Immunocompromised = immunocompromised,
Healthcare = healthcare, Nursing_Home = nursing_home,
Jailed = jailed, Positives = positives, 
Deaths_Nursing_Home = d_nursing_home, 
Deaths_Jailed = d_jailed,
Deaths = deaths, Deaths_Hispanic = d_hispanic,
Deaths_Nonhispanic = d_nonhispanic,
Cases_45_54 = age_6,
Deaths_45_54 = d_age_6,
Cases_55_64 = age_7,
Deaths_55_64 = d_age_7,
Cases_65 = age_8,
Deaths_65 = d_age_8,
Noncovid_Death = noncovid_death, 
#New Data As of Aug 6
Hosp_0_10	= hosp_age_1,
Hosp_11_17 = hosp_age_2,
Hosp_18_24 = hosp_age_3,
Hosp_25_34 = hosp_age_4,
Hosp_35_44 = hosp_age_5,	
Hosp_45_54 = hosp_age_6,	
Hosp_55_64 = hosp_age_7,
Hosp_65	= hosp_age_8,
#Active cases by Gender
Active_Male = active_m,
Active_Female =active_f,
Active_Unknown = active_u,
Active_Multi_Race = active_multi_race,
Active_White = active_white,
Active_Black = active_black,
Active_Asian = active_asian,
Active_Native_American = active_ai_an,
Active_Pacific_Islander =	active_nh_pi,
Active_Other = active_other,
Active_Unknown2 =		active_unk,
Active_Hispanic	=	active_hispanic,
Active_NonHispanic	=	active_non_hispanic,
Active_0_4	=	active_age_1,
Active_5_11	=	active_age_2,
Active_12_18 =		active_age_3,
Active_19_24	=	active_age_4,
Active_25_34	=	active_age_5,
Active_35_44	=	active_age_6,
Active_45_54	=	active_age_7,
Active_55_64	=	active_age_8,
Active_65_Plus =	active_age_9,
#Immunity
Active_fully_immu	=	active_fully_immu,
Hospital_fully_immu	=	hospital_fully_immu,
Vent_fully_immu	=	intubated_fully_immu,
Deaths_fully_immu	=	deaths_fully_immu,
Cases_fully_immu	=	cases_fully_immu,
Total_hosp	=	total_hosp,
Total_intub	=	total_intub,
Date = date)

#Change the date on the .csv file below
demname <- paste("demographics_",date,".csv",sep="")
write.csv(today_demo, file=demname)

write.csv(today_demo, "demographics_Aug7.csv")
...
```{r}
yesterday_age <- age3 %>% 
   select("Date", "Cases_0_10", "Cases_11_17", "Cases_18_24", "Cases_25_34", "Cases_35_44", "Cases_45_54", "Cases_55_64", "Cases_65", "Deaths_0_17", "Deaths_18_24", "Deaths_25_34", "Deaths_35_44", "Deaths_45_54", "Deaths_55_64", "Deaths_65") %>% 
...
twodays <- smartbind(today_age, yesterday_age)
glimpse(twodays)
```
...
#age_master <- age_master[ -c(2) ]
age_master$Deaths_0_17 <- as.numeric(age_master$Deaths_0_17)
age_master$New_Deaths_0_17 <- as.numeric(age_master$New_Deaths_0_17)
...
#fact check totals
sum(age_new_cases$New_Cases)
```

#New Deaths Today Table for Flourish
```{r}
age_new_deaths <- age_master %>% 
  select(Date, New_Deaths_0_17, New_Deaths_18_24,  New_Deaths_25_34, New_Deaths_35_44, New_Deaths_45_54, New_Deaths_55_64, New_Deaths_65) %>% 
  filter(Date == today) %>% 
  distinct()

#flip
age_new_deaths <- gather(age_new_deaths, key = "Age", value = "New_Deaths", New_Deaths_0_17, New_Deaths_18_24,  New_Deaths_25_34, New_Deaths_35_44, New_Deaths_45_54, New_Deaths_55_64, New_Deaths_65)
...
#Fact Check
sum(age_new_deaths$New_Deaths, na.rm=TRUE)
...
race_new_cases
sum(race_new_cases$New_Cases, na.rm=TRUE)
```
...
```{r}
active_age <- today_demo %>% 
  select(Date, Active_0_4, Active_5_11, Active_12_18, Active_19_24, Active_25_34, Active_35_44, Active_45_54, Active_55_64,
Active_65_Plus)

#Change the date on the .csv file below
agename <- paste("active_age_",date,".csv",sep="")
write.csv(active_age, file=agename)

```

```{r}
hospital_age <- today_demo %>% 
  select(Date, Hosp_0_10, Hosp_11_17, Hosp_18_24, Hosp_25_34, Hosp_35_44, Hosp_45_54, 
Hosp_55_64, Hosp_65)

#Change the date on the .csv file below
hospname <- paste("hospital_age_",date,".csv",sep="")
write.csv(hospital_age, file=hospname)
...
```{r}
stats <- today_demo %>% 
  select(Date, active_cases, percent_fully_active, percent_fully_cases, percent_fully_deaths, percent_fully_hosp, percent_fully_intub)

#Change the date on the .csv file below
statsname <- paste("stats_",date,".csv",sep="")
write.csv(stats, file=statsname)
