...
write.csv(today_demo, "demographics_AugXX.csv")
...
today_age_calcs$New_Deaths_0_17 <- as.numeric("3")
...
write.csv(active_age, "active_age.csv")
...
write.csv(hospital_age, "hospital_age.csv")
