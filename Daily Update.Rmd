...
ggplot(df2,aes(x = mydate, y = value, label = value, fill= variable)) + 
  ...
  labs(title = "New Cases & Deaths in Arkansas Announced Today", 
       subtitle = "Confirmed + Probable,  ADH Data for Oct. 16, 2020",
...
ggplot(df3,aes(x = mydate, y = value, label = value, fill= variable)) + 
  ...
  labs(title = "Active Cases & Total Deaths in Arkansas Announced Today", 
       subtitle = "Confirmed + Probable,  ADH Data for Oct. 31, 2020",
       caption = "Graphic by ArkansasCovid.com",
       y="Amount",
       x="Date")
...
write.csv(hospital_FLOURISH, "hospital_FLOURISH.csv")
```
