...
```{r}
#Build a flipped table, ugly style
...
scale_y_continuous(limits=c(0, 4500))  +
  ...
  labs(title = "New Cases & Recoveries in Arkansas Announced Today", 
       subtitle = "Confirmed + Probable,  ADH Data for Jan. 30, 2021",
...
write.csv(vaccinemarshallese, "vaccine_marshallese.csv")
```
