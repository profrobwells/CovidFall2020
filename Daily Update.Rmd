...
```
--**Backup in case Google oauth import fails**
```{r}
#negToday <- rio::import("https://docs.google.com/spreadsheets/d/1ikblX8tikM59ma1AftkqgGbyeZkXB6DuBtwMsVeoGYw/edit#gid=701586163", which = "Negative Tests")
```
...
```
--**Check the date is correct**
--**run this only if the date is off**
...
```{r}
neghistory <- rio::import("https://github.com/profrobwells/CovidFall2020/raw/master/negatives_history_master.csv")
...
write.csv(NEGATIVES_MASTER, "negatives_history_master.csv")
```
...
write.csv(TODAYCOUNTYSTATE, "Day_9_10_2020.csv")
```
