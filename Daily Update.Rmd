...
#-------------------------------------------
#-------------------------------------------
#Vaccine Data - New Section May 19, 2021
...
write.csv(vax1, "vaccine_county_full.csv")
...
write.csv(vaccine_county, "vaccine_county.csv")
date <- Sys.Date()
...
vaccinecounty1 <- vax1 %>% 
  select(County_Name, Partial_Vax, Partial_Pct, Full_Vax, Full_Pct, Unknown_Dose, Unknown_Pct, population, Date)
...
#Add to master file
```{r}
vaxmaster <- rio::import("https://raw.githubusercontent.com/Arkansascovid/Main/master/vaccine_master.csv")
...
write.csv(vaccine_master, "vaccine_master.csv")
