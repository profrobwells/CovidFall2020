...
homepage <- homepage %>%
  rename('County Name' = County_Name,  'New Cases Today'=  New_Cases_Today, 'New Deaths Today' = New_Deaths_Today, 'Active Cases' = Active_Cases)
...
homepage_spanish <- homepage %>% 
  rename(Candado = 'County Name', 'Nuevos Casos Hoy' = 'New Cases Today', 'Nuevas Muertes Hoy' = 'New Deaths Today', Muertes = Deaths, 'Casos Activos' = 'Active Cases') %>% 
