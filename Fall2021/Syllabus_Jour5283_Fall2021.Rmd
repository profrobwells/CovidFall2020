---
title: 'Jour 5283 Data Journalism: Fall 2021 Syllabus'
output:
...
This course will report on an evolving news story, the COVID-19 outbreak in Arkansas.
 ...
 We will examine Covid-19 data in Arkansas and produce stories based on this data, primarily on racial disparities with the disease. We will send out Tweets and produce podcasts.
...
**Learning Outcomes:** 
    ...
    R Coding.   
    Jour 5283 students receive additional and detailed instructon in the R programming language, which distinguishes the graduate-level work from the undergraduate section of this course. R is used widely in newsrooms for data    gathering, statistical modeling and data visualization. At the end of the course, you will be able to execute    basic R commands, perform simple calculations, import datasets and create data visualizations.
...
The book is under development under an open textbook grant from the university - so please be patient! Send any notes about issues to me, please.
...
Due to the uncertainty surrounding COVID-19, this course may have to switch to remote delivery on short notice. I will keep you informed about any such developments.
...
Bring headsets or earbuds to class to listen to any video / podcast material.
...
**2: Reporting Memo with Tableau Chart.**  Due Oct 5  
Students gather, analyze and visualize Arkansascovid data and produce a Tableau chart suitable for publication. Data dictionary required. Report and write a 400 word story and provide social media. Jour 5283 students use R to gather, process data. Turn in R Markdown script.

**3: Interactive Map.** Due Oct 26  
Students will build interactive maps of Arkansascovid data. Results will be posted on GitHub. Data dictionary required. Basic R used for analysis. Jour 5283 students use R to gather, process data, join tables. Turn in R Markdown script. Report and write a 400 word story.

**4: Interactive Data Visualization.** Due Nov 16.
Students build multipanel interactive graphics / maps of Arkansascovid data by school district. Basic R used for analysis. Results will be posted on GitHub. Data dictionary required. Report and write a 600 word story.Jour 5283 students use R to gather, process data, including joining tables. Turn in R Markdown script.

**5: Multimedia Data Story.** Due Dec. 3.
Students will produce a blog post with photos, a short video, a map and an interactive graphic plus a 400 word story. Results will be posted on GitHub. Data dictionary required. Jour 5283 students use R to gather, process data and produce static data visualizations. Turn in R Markdown script.
