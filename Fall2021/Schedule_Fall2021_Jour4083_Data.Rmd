...
> [**Syllabus - Jour 401v**: "CNTL" + click for a New Tab](https://profrobwells.github.io/CovidFall2020/Fall2021/Syllabus_Jour4083_Fall2021.html){target="_blank"}   
...
**Agenda:**   
    ...
    --Blackboard site
    --Arkansascovid.com
    --Excel / Flourish Exercise with Arkansascovid data
    --Teams
    --Interview a classmate for homework

**Discuss Syllabus**

https://forms.office.com/r/nrySuungzH
  
**Basic Excel**   

    Click below on the ebook link, See Section "3 Introduction to Data Analysis"
...
Write 200 Word Story Introducing A Classmate To The Rest of Us.
Due Tuesday, 11:59 pm, Blackboard.

What questions will you ask? Let's brainstorm

https://docs.google.com/document/d/10ZlhnxEkJi88spQ_3lyGni8TtF97KcIu1R5nAQonfLk/edit?usp=sharing


**Read / View Before Next Class**    
...
**Agenda**  
      ...
      Pair-Share on Sheffro reading
      Resume Excel exercise - sorting
      Intro to Flourish
...
--See exercise in Ch. 4 Excel Bootcamp


    See Ch. 7, Organize Your Data   
...
**Jour 5083 _ Nerd Corner**   
    ...
    Ch. 13 R Introduction, get the program loaded on your computer, walk through a script in the next class.
...
**Homework / Reading due Tuesday, Sept. 7, 11:59 p.m.**

Includes Data Literacy Test
See Blackboard.
...
**Reminder: Assignment 1: Data Analysis. Due Sunday Sept. 12**
...
**Reminder: Assignment 2: Reporting Memo with Tableau Chart, Due Oct 5  **
Students gather, analyze and visualize Arkansascovid data and produce a Tableau chart suitable for publication. Data dictionary required. Report and write a 400 word story and provide social media.
...
## Monday, Oct. 12: Context and Story Selection   

--Histograms   
--Rates and Ratios   
--Weighted Averages   
--Vaccinations by Race example   
...
## Wednesday Oct. 13: Context and Story Selection
...
**Discuss Assignment 3: Interactive Map. Due Oct 26**   
...
**Assignment 4: Interactive Data Visualization. Due Nov 16.**
Students build multipanel interactive graphics / maps of Arkansascovid data by school district. Basic R used for analysis. Results will be posted on GitHub. Data dictionary required. Report and write a 600 word story.
