...
schoolraw <- rio::import("/Users/robwells/Dropbox/Classes/Data Fall 2020/ArkansasCovid/Schools/School_Report_08302021.xlsx")
...
schoolraw <- schoolraw[!grepl("cAugust 30, 2021", schoolraw$Name),]
...
#aug16 <- schoolraw
# 
#schools_master_2021 <- rbind(aug30, aug26, aug23, aug19, aug16)


# schools_master_2021[4:11] <- lapply(schools_master_2021[4:11], as.numeric)
# schools_master_2021$Date <- as.Date(schools_master_2021$Date)
```
...
write.csv(school_master_totals, "school_master_totals.csv")
```
...
write.csv(schools_details, "school_details.csv")
...
```{r}
collegeenroll <- rio::import("https://github.com/profrobwells/CovidFall2020/blob/master/Schools/School%20College%20Enrollment%20Data.xlsx?raw=true", which = "NCES_College_info")
...
write.csv(college_combo, "college_combo.csv")
