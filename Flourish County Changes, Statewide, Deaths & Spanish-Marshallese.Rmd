...
write.csv(homepage_marshallese, file = "homepage_marshallese.csv")
```
...
write.csv(countyonlytoday_marshallese, file = "countyonlytoday_marshallese.csv")
...
write.csv(Top_counties_new_cases_marshallese, file = "Top_counties_new_cases_marshallese.csv")
...
write.csv(deaths_daily_marshallese, file = "deaths_daily_marshallese.csv")
```
...
write.csv(countysnapshot_marshallese, file = "countysnapshot_marshallese.csv")
...
write.csv(datawrapper_marshallese, file = "datawrapper_marshallese.csv")
```
