...
#### Homework due Saturday, Sept. 5, 11:59 p.m.
      ...
      Another exercise will test out your Twitter skills. It is not a live Tweeting exercise. That will come this week!
    
      Tweeting: Examine the Arkansascovid.com data for Sept. 4.   
    
      Create a Google Doc.   
    
    Produce four draft tweets based on new cases, deaths and two other items based on Gov. Hutchison's Sept. 4 press conference, found here:
