...
This script creates new legacy data columns from yhe county_state_master that reflect the old PCR totals back to March 23. For a time series going beyond Sept 13, 2020, you will use the PCR totals and for comparison use the "confirmed_pos" or "confirmed_neg" 
...
colnames(county_state_master)[3] <- "positive_legacy"
colnames(county_state_master)[4] <- "negative_legacy"
colnames(county_state_master)[5] <- "recoveries_legacy"
colnames(county_state_master)[6] <- "deaths_legacy"
colnames(county_state_master)[7] <- "total_tests_legacy"
colnames(county_state_master)[8] <- "active_cases_legacy"
colnames(newcountydata)[1] <- "county_name"
colnames(newcountydata)[38] <- "date"
